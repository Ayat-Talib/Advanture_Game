...
function checkInventory() {
    ...
    for (const item in inventory) {
        if (Object.prototype.hasOwnProperty.call(inventory, item)) {
            console.log(chalk.hex('#00BFFF')(`${item}: ${inventory[item]}`));
        }
    }
}
    ...
    response.then((answer) => {
        switch (answer.action) {
            ...
            case "Use your machete to fight":
                ...
                console.log(chalk.hex('#FF4500')("With quick reflexes and the sharp edge of your machete, you manage to defeat the tiger."));
                console.log(chalk.hex('#FF4500')("Though injured, you emerge victorious!\n"));
                break;
